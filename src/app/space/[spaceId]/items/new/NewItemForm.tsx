...
import { createNewItem } from "@/actions/item.actions";
    ...
    return (
        <>
            ...
            <form className="w-full flex flex-col items-center gap-5" action={async (formData) => {
                ...
                console.log("LKSJFLKJF");

                await createNewItem(props.spaceId, sku, itemName, locationId);
                ...
                <label className="form-control w-1/2">
                    <div className="label"><span className="label-text">Item Name *</span></div>
                    <input type="text" name="item-name" id="item-name" className="input bg-base-100 w-100 text-base-content" placeholder="Item Name" />
                </label>

                <label className="form-control w-1/2">
                    <div className="label"><span className="label-text">SKU *</span></div>
                    <input type="text" name="sku" id="sku" className="input bg-base-100 w-100 text-base-content" placeholder="SKU" />
                </label>
