...
const NewItem = async ({ params }: { params: SpaceParams }) => {
    ...
    const redirectURL = `/space/${params.spaceId}/items`;
    ...
    return (
        <div className="h-full w-full flex relative flex-col items-center">
            <div id="header" className="w-full h-28 flex items-center justify-between pl-10">
                ...
                <h1 className="text-4xl">Create New Item</h1>
                <div className="w-5"></div>
            </div>

            <div className="mt-10 w-full">

                <NewItemForm spaceId={params.spaceId} locations={locations} redirectURL={redirectURL} />
